...
public class QPaymentHistory extends EntityPathBase<PaymentHistory> {
    ...
    private static final long serialVersionUID = 214468443L;
    ...
    public final EnumPath<com.example.i_commerce.domain.order.entity.emuns.ActorType> actorType = createEnum("actorType", com.example.i_commerce.domain.order.entity.emuns.ActorType.class);
