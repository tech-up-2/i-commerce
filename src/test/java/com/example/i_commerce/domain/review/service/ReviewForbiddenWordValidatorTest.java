...
class ReviewForbiddenWordValidatorTest {
    ...
    void validateContent_success() {
        ...
        assertDoesNotThrow(() -> reviewForbiddenWordValidator.validateContent(cleanContent));
    }
    ...
    void validateContent_throwsException_whenForbiddenWordIncluded() {
        ...
        // when & then.
        assertThatThrownBy(() -> reviewForbiddenWordValidator.validateContent(badContent))
    ...
    void validateContent_skip_whenContentIsNullOrEmpty() {
        // when & then
        assertDoesNotThrow(() -> reviewForbiddenWordValidator.validateContent(""));
        assertDoesNotThrow(() -> reviewForbiddenWordValidator.validateContent(null));
    }
}
